...
| src/LevrTreasury_v1.sol | 64 |
| src/base/ERC2771ContextBase.sol | 15 |
| src/interfaces/ILevrDeployer_v1.sol | 13 |
...
| src/interfaces/ILevrTreasury_v1.sol | 15 |
...
- Found in src/LevrTreasury_v1.sol [Line: 61](src/LevrTreasury_v1.sol#L61)

	```solidity
	        IERC20(token).approve(project.staking, amount);
	```

- Found in src/LevrTreasury_v1.sol [Line: 65](src/LevrTreasury_v1.sol#L65)
...
- Found in src/LevrDeployer_v1.sol [Line: 21](src/LevrDeployer_v1.sol#L21)

	```solidity
	        require(factory_ != address(0));
	```

- Found in src/LevrTreasury_v1.sol [Line: 27](src/LevrTreasury_v1.sol#L27)

	```solidity
	        if (governor != address(0)) revert();
	```

- Found in src/LevrTreasury_v1.sol [Line: 28](src/LevrTreasury_v1.sol#L28)
...
- Found in src/LevrTreasury_v1.sol [Line: 47](src/LevrTreasury_v1.sol#L47)
...
- Found in src/LevrTreasury_v1.sol [Line: 82](src/LevrTreasury_v1.sol#L82)
...
- Found in src/interfaces/ILevrTreasury_v1.sol [Line: 19](src/interfaces/ILevrTreasury_v1.sol#L19)
...
- Found in src/LevrTreasury_v1.sol [Line: 80](src/LevrTreasury_v1.sol#L80)
